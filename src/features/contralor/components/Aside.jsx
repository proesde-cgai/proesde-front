...
import { getRequisitos } from "../../inconformidad/services/requisitosService";
import TableSearch from "../../../reutilizable/TableSearch";
import Select from "../../../reutilizable/Select";
import Alerta from "../../../reutilizable/Alert";
...
const Aside = ({ selectVisible = false, alias }) => {
  ...
  const { loading, hasSearched, paginationRecords, setPageNumber, setLoading, query } = useSearchStore((state) => ({
    ...
    <aside className={styles.aside}>
      ...
      <div className={styles.containerList}>
        {showAlert && academicos.length === 0 && hasSearched ? (
          ...
          loading ? (<Loading />) : (
            academicosOrdenados?.map((academico) => (
              <div
