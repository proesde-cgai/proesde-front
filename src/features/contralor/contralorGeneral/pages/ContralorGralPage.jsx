...
import styles from "./styles/ContralorGralPage.module.css";
import ArmarExpedientePage from '../../../academico/expediente/pages/ArmarExpedientePage';
...
export const ContralorGralPage = () => {
