...
import { obtenerDocentes, obtenerCicloActual, obtenerSizeList, obtenerMaterias } from "../services/listDocumentos";

const useListCargaHoraria = (setMaterias, selectedCiclo, currentPage = 1, userInfo, setFilteredMaterias) => {
