...
import GenerarReportePage from "../../secretariaAdminSems/GenerarReportes/page/GenerarReportePage";
import styles from "./styles/SecretariaAdmunCuPage.module.css";


const API_BASE_URL = process.env.REACT_APP_API_BASE_URL;
const API_URL_SUBMENUS = `${API_BASE_URL}/api/v1/actividad/secretaria_admin_cu`;

export const SecretariaAdminCuPage = () => {
  ...
  const componentMap = {
    ...
    "Generar reportes": <GenerarReportePage />,
  ...
  useEffect(() => {
    ...
    if (previousElementRef.current !== null &&
      ...
      clearFormData();
      setQuery("");
      // Limpiar el estado del académico seleccionado al cambiar de vista
      resetSelectedDataAcademico();
    }
    // Actualizar la referencia al elemento actual
    previousElementRef.current = menu.element;
  }, [menu.element, clearFormData, setQuery, resetSelectedDataAcademico]);
