...
import { getDatosParticipante, getEmailUdgService } from "../services/datosParticipanteService";
...
export const DatosParticipante = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_URL_CORREO_PROESDE}${selectedDataAcademico?.codigo}`, {
        headers: {
            Accept: '*/*',
  ...
  /* const isEmptyDatosParticipante =
    Object.values(datosParticipante).length === 0;
          ...
          <div className={styles.containerTableData}>
            ...
            <div className={styles.inputContainer}>
              ...
              <input
                ...
                type="text"
                value={
                  (ultimoGradoNombre && ultimoGradoNombre.trim() !== "" ? ultimoGradoNombre
                    : ultimoGrado && ultimoGrado.trim() !== "" ? ultimoGrado
                    : "Sin registro")
                }
                readOnly
              />
            ...
            <div className={styles.inputContainer}>
              ...
              <input
                ...
                type="text"
                value={nombrePosgrado ?? nombreGradoAcademico ?? "Sin registro"}
                readOnly
              />
            </div>
            <div className={styles.inputContainer}>
            ...
            <div className={styles.inputContainer}>
              ...
              <input
                ...
                type="email"
                value={
                  (correoProesde && correoProesde.emailUdg) ? correoProesde.emailUdg : "Sin registro"
                }
                readOnly
              />
            </div>
            ...
            <div className={styles.inputContainer}>
              ...
              <input
                id="telefonoMovil"
                type="tel"
                value={telefonoMovil ?? movil ?? "Sin registro"}
                readOnly
              />
            </div>
            <div className={styles.inputContainer}>
          ...
          <div className={styles.containerTableData}>
            <div className={styles.inputContainer}>
              ...
              <input
                ...
                type="text"
                value={
                  (nombreNombramiento && typeof nombreNombramiento === "string" && nombreNombramiento.trim() !== "")
                    ? nombreNombramiento.toUpperCase()
                  : (typeof nombramiento === "string" && nombramiento.trim() !== "")
                    ? nombramiento.toUpperCase()
                    : "Sin registro"
                }
                readOnly
              />
            ...
            <div className={styles.inputContainer}>
              ...
              <input
                id="dependencia"
                type="text"
                value={nombreDependencia ?? dependencia ?? "Sin registro"}
                readOnly
              />
            </div>
            <div className={styles.inputContainer}>
              ...
              <input
                id="municipio"
                type="text"
                value={municipio ?? municipioDependencia ?? "Sin registro"}
                readOnly
              />
            </div>
            <div className={styles.inputContainer}>
              ...
              <input
                id="fechaIngreso"
                type="text"
                value={fechaIngresoFormato ?? "Sin registro"}
                readOnly
              />
            </div>
            <div className={styles.inputContainer}>
